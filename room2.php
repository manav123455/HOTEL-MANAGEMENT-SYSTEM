            ...
            <div class="card mb-3 room-1">
                <div class="row no-gutters">
                    <div class="col-md-4 rooms-1">
                        <img src="images/r3.png"card-img alt="...">
                    </div>
                    <div class="col-md-8">
                        <div class="card-body">
                            <h1 class="card-title lux-1">Double Bed</h1>
                            <p class="card-text luxs-1">The room is bigger than single room having attached bathroom, study table, wardrobe, luggage rack, coffee table with sofa chair etc
                            </p>
                                    ...
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                      <div class="modal-content">
                                        ...
                                        <form action="reservation.php" method="POST">
                                            <input type="hidden" name="r_name" value="double bed">
                                                <div class="form-row">
