                ...
                <div class="row no-gutters">
                    ...
                    <div class="col-md-8">
                        <div class="card-body">
                            ...
                            <p class="card-text luxs-1">Presidential suites may have facilities such as a private conference room, while Royal suites may have a formal reception room instead. People sometimes reside in these suites on a permanent basis, such as wealthy families that enjoy this type of suite in a semi-private manner for special rates.
                                    ...
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                      <div class="modal-content">
                                        <div class="modal-header">
                                          <h5 class="modal-title" id="exampleModalLongTitle">Presidential Suite</h5>
                                        ...
                                        <form action="reservation.php" method="POST">
                                            <input type="hidden" name="r_name" value="presidential suite">
                                                <div class="form-row">
