...
<head>
    <title>Hollywood Twin Room</title>
                ...
                <div class="row no-gutters">
                    ...
                    <div class="col-md-8">
                        <div class="card-body">
                            ...
                            <p class="card-text luxs-1">The room has two single beds with common headboard which are separate from each other meant for two people. It is patronized by colleagues or friends
                            </p>
                                    ...
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                      <div class="modal-content">
                                        <div class="modal-header">
                                          <h5 class="modal-title" id="exampleModalLongTitle">Hollywood Twin Room</h5>
                                        ...
                                        <form action="reservation.php" method="POST">
                                            <input type="hidden" name="r_name" value="hollywood twin room">
                                                <div class="form-row">
