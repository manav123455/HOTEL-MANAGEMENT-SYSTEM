                ...
                <div class="row no-gutters">
                    ...
                    <div class="col-md-8">
                        <div class="card-body">
                            ...
                            <p class="card-text luxs-1">It is a room situated at swimming pool. It may be or may not be for staying purpose. It is usually used by that guest who want to spend maximum time at swimming pool.
                            </p>
                                    ...
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                      <div class="modal-content">
                                        <div class="modal-header">
                                          <h5 class="modal-title" id="exampleModalLongTitle">Cabana room</h5>
                                        ...
                                        <form action="reservation.php" method="POST" >
                                            <input type="hidden" name="r_name" value="cabana rom">
                                                <div class="form-row">
